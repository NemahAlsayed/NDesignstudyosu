...
categories: ["fashion", "wedding", "style"]
...
<head>
    ...
    <title>Bridal on a Budget 2026 · Cream & Rose Gold</title>
...
<div class="container">
    ...
    <div class="article-header">
        ...
        <div class="meta">
            ...
            <span>📂 <a href="#">wedding</a> / <a href="#">style</a></span>
        </div>
        <!-- Featured image -->
        <div class="featured">
    ...
    <!-- CTA -->
    <div class="hero-cta">
        <a class="cta-link" href="https://o-201-6764-1.bstny.net" target="_blank" rel="sponsored nofollow">✦ shop special offers ✦</a>
        <div class="cta-small">⭐ I have picked these for you — <strong>copy the SKU</strong> &amp; paste in Shein search.</div>
    </div>
    <!-- GRID -->
    <div class="grid" id="bridalGrid"></div>
    <div class="footnote">
        <span>💍</span> curated with love · all items from Shein · <a href="https://o-201-6764-1.bstny.net" target="_blank" rel="sponsored">exclusive deals</a> · 2026
    </div>
</div>
...
<script>
    (function() {
        ...
        const items = [
            ...
            { category: "Crown", sku: "sc25041870992210121", link: "https://o-201-6764-1.bstny.net", img: "images/Crown1.png", desc: "Gold & white rhinestone crown, alloy, perfect for bridal photos." },
            { category: "Jewelry", sku: "sj260819110329157758339", link: "https://o-201-6764-1.bstny.net", img: "images/Jewelry4.png", desc: "S925 silver moissanite ring set, vintage pear accents, stackable." },
            { category: "Crown", sku: "sc2308022196572272", link: "https://o-201-6764-1.bstny.net", img: "images/Crown2.png", desc: "Luxurious alloy rhinestone headband, royal tiara style." },
            { category: "Bag", sku: "sg260330183171895064302", link: "https://o-201-6764-1.bstny.net", img: "images/Bag1.png", desc: "Floral pattern handbag, evening bag for brides & bridesmaids." },
            { category: "Bag", sku: "sg2405212540395877", link: "https://o-201-6764-1.bstny.net", img: "images/Bag2.png", desc: "Satin pleated box clutch, crossbody, perfect for prom & wedding." }
        ];
        ...
        items.forEach(item => {
            ...
            desc.className = 'desc';
            desc.textContent = item.desc || 'Elegant bridal piece';
            ...
            linkHint.innerHTML = `↗ <a href="${AFFILIATE_BASE}" target="_blank" rel="sponsored nofollow">view on Shein</a> <span style="font-size:0.6rem; opacity:0.5;">(affiliate)</span>`;
            card.appendChild(linkHint);

            // card click -> affiliate
